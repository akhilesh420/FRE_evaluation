...
export const View = (() => {
    ...
    const createTmp = (arr) => {
        ...
        arr.forEach((todo) => {
            ...
            <div class="row todo">
                <div class="col">
                    <div class="circle ${todo.completed ? 'complete' : ''}"></div>
                </div>
                <div class="col todo-item-container">
                    <div class="row todo-item ${todo.completed ? 'item-completed' : ''}">${todo.content}</div>
                </div>
                <div class="col editbtn">
